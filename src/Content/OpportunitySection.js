...
export default function OpportunitySection() {
    return (
        <section className="opportunitysection section" id="opportunities">
            ...
            text1="Real World Buisness/Technical Learning, as well as there is evident gap of qualified good professors also. Get connected with them to get knowledge."
            img2={Dreams}
